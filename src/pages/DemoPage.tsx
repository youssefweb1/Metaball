...
export default function DemoPage() {
  ...
  const handleWatchVR = (matchId: string, accessCode: string) => {
    navigate(`/vr?match=${matchId}&code=${accessCode}`);
  };
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-3">
                    <button
                      ...
                      className="w-full py-2 px-4 rounded-lg bg-black bg-opacity-50 border border-neon-green text-neon-green hover:bg-neon-green hover:text-dark transition-all flex items-center justify-center space-x-2"
                    >
                      <Lock size={18} />
                    ...
                    <button
                      onClick={() => handleWatchVR(match.id, match.accessCode)}
